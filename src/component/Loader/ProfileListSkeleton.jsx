...
function ProfileListSkeleton() {
	return (
		<div className="bg-white border rounded-lg shadow-sm p-3 md:p-4 mb-10 flex flex-col sm:flex-row items-start sm:space-x-6 md:space-x-8 animate-pulse">
			{/* Image Skeleton */}
			<div className="box flex-shrink-0 flex items-center justify-center relative w-full sm:w-auto rounded-xl overflow-hidden bg-gray-200">
				<div className="absolute inset-0 bg-gray-200"></div>
				<div className="absolute inset-0 rounded-xl"></div>
				<div className="relative z-10 w-full h-96 sm:w-64 sm:h-64 bg-gray-300"></div>
			</div>
