...
const Skip = () => {
	const [ data, setData ] = useState([
		...
		{ id: 3, image: 'https://via.placeholder.com/50', name: 'Sam Johnson', age: 22, status: 'Active', religion: 'Hindu', location: 'Delhi', motherTongue: 'Hindi' },
	]);
	...
	return (
		<section className="box-shadow bg-white border rounded-md">
			<p className='px-6 py-3 font-medium border-b text-headingGray'>Ignored Members</p>
