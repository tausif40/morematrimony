...
const Viewed = () => {
	const [ data, setData ] = useState([
		...
		{ id: 2, image: 'https://via.placeholder.com/50', name: 'John Doe', age: 25, status: 'Active', religion: 'Christian', location: 'New York', motherTongue: 'English' },

		{ id: 3, image: 'https://via.placeholder.com/50', name: 'Sam Johnson', age: 22, status: 'Active', religion: 'Baudh', location: 'Delhi', motherTongue: 'Hindi' },
	]);
