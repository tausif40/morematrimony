...
import { getViewedYou } from '../../../store/features/userAction-slice';
import male from '../../../img/male.png'
import female from '../../../img/female.png'
import { Link } from 'react-router-dom';

const mapViewedYouList = (profiles) => {
...
const ViewedYou = () => {
	...
	const viewedYouList = useSelector((state) => state.userAction.viewedYou);
	...
	const profiles = useMemo(() => mapViewedYouList(viewedYouList?.data?.socialAction), [ viewedYouList?.data?.socialAction ]);
	...
	useEffect(() => {
		...
		console.log("viewed You List - ", viewedYouList);
	}, [ viewedYouList ])
	...
	return (
		<section className="box-shadow bg-white border rounded-md">
			<p className='px-6 py-3 font-medium border-b text-headingGray'>Viewed You List</p>
