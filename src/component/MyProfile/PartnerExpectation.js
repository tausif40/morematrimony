	...
	return (
		<div className="box-shadow bg-white border rounded-md mx-auto">
			...
			<form className="md:grid grid-cols-2 gap-4 py-4 px-6 text-sm space-y-5 md:space-y-0" onSubmit={handleSubmit}>
				{/* General Requirement */}
				<div>
					<label htmlFor="generalRequirement" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">General Requirement</label>
					<input
						type="text"
				...
				{/* Residence Country */}
				<div>
					<label htmlFor="residenceCountry" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Residence Country</label>
					<input
						type="text"
						id="residenceCountry"
						className="input-field"
				...
				{/* Min Height */}
				<div>
					<label htmlFor="minHeight" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Min Height (In Feet)</label>
					<input
						type="text"
						id="minHeight"
						className="input-field"
				...
				{/* Max Weight */}
				<div>
					<label htmlFor="maxWeight" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Max Weight (In Kg)</label>
					<input
						type="text"
						id="maxWeight"
						className="input-field"
				...
				{/* Height */}
				<div>
					<label htmlFor="height" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Height</label>
					<input
						type="text"
						id="height"
						className="input-field"
				...
				{/* Weight */}
				<div>
					<label htmlFor="weight" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Weight</label>
					<input
						type="text"
						id="weight"
						className="input-field"
				...
				{/* Children Acceptable */}
				<div>
					<label htmlFor="childrenAcceptable" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Children Acceptable</label>
					<input
						type="text"
				...
				{/* Language */}
				<div>
					<label htmlFor="language" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Language</label>
					<select
						id="language"
						className="input-field text-text"
						name="language"
				...
				{/* Education */}
				<div>
					<label htmlFor="education" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Education</label>
					<input
						type="text"
						id="education"
						className="input-field"
				...
				{/* Profession */}
				<div>
					<label htmlFor="profession" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Profession</label>
					<input
						type="text"
						id="profession"
						className="input-field"
				...
				{/* Smoking Acceptable */}
				<div>
					<label htmlFor="smokingAcceptable" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Smoking Acceptable</label>
					<input
						type="text"
				...
				{/* Drinking Acceptable */}
				<div>
					<label htmlFor="drinkingAcceptable" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Drinking Acceptable</label>
					<input
						type="text"
				...
				{/* Dieting Acceptable */}
				<div>
					<label htmlFor="dietingAcceptable" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Dieting Acceptable</label>
					<input
						type="text"
				...
				{/* Manglik */}
				<div>
					<label htmlFor="manglik" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Manglik</label>
					<input
						type="text"
						id="manglik"
						className="input-field"
				...
				{/* Preferred Country */}
				<div>
					<label htmlFor="preferredCountry" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Preferred Country</label>
					<input
						type="text"
						id="preferredCountry"
						className="input-field"
				...
				{/* Preferred State */}
				<div>
					<label htmlFor="preferredState" className="block font-medium mb-1 md:mb-2 mt-1 text-headingGray">Preferred State</label>
					<input
						type="text"
						id="preferredState"
						className="input-field"
