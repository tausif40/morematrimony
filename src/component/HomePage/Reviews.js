	...
	return (
		<>
			<section
				...
				style={{
					backgroundImage: `url(${require('../../img/img14.png')})`,
			...
			>
				<div className="flex flex-col items-center text-white">
					...
					<img src="./assets/img/img12.jpeg" alt="Member" className="rounded-full mx-auto size-48 object-cover border-4 border-white mt-[4%]" />
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 32 32">
						<path fill="#ad434d" d="M4 8v10h8c0 2.219-1.781 4-4 4v2c3.3 0 6-2.7 6-6V8zm14 0v10h8c0 2.219-1.781 4-4 4v2c3.3 0 6-2.7 6-6V8zM6 10h6v6H6zm14 0h6v6h-6z" />
					</svg>
				</div>
			</section>
