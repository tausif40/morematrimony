		...
		<>
			<section className="relative">
				...
				<div className="absolute inset-0 flex flex-col sm:flex-row justify-between items-center py-4 sm:pt-0 text-white">
					<div className="text-4xl md:text-2xl font-semibold lg:font-bold max-w-3xl ml-1 px-2 py-2 lg:pl-20 pr-10 lg:pr-16 bg-[#FFD700] bg-opacity-60 outline outline-[5px] outline-white/[.60]">
