...
const ImageUploader = () => {
	...
	return (
		<>
			{/* <div className=' border p-4 rounded-md shadow-sm min-h-80'> */}
			<div className=" flex flex-col items-center justify-center p-4 shadow-md border bg-gray-100 rounded min-h-72 w-full">
